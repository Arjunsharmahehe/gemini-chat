...
function Alert({ message, setShowingThoughts, showSidebar }: { message: string, setShowingThoughts: React.Dispatch<React.SetStateAction<boolean>>, showSidebar: boolean }) {
  ...
  return (
      ...
      <div className='px-3 py-2 absolute z-10 top-0 right-0 gap-3 flex bg-neutral-900 border-2 border-neutral-900/50 hover:border-neutral-900/80 flex-col w-3/4 md:w-2/3 lg:w-2/5 h-[99vh]'
